  ...
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" :form="form">
        <a-row :gutter="48">
          <!-- <a-col :md="4" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="托盘垛数量">
              <a-input placeholder="托盘垛数量" v-decorator="['location_code']" />
            </a-form-item>
          </a-col> -->
          <a-col :md="4" :sm="24">
          ...
          <a-col :md="4" :sm="24">
            <span class="table-page-search-submitButtons">
              <a-button type="primary" @click="GetEmptyPalletByWarehouse('空托盘')">
                呼叫空托盘
              </a-button>
              <a-button type="primary" style="margin-left: 8px"
                @click="GetEmptyPalletByWarehouse('空托盘垛')">
                呼叫空托盘垛
              </a-button>
            </span>
          </a-col>
...
export default {
  ...
  methods: {
    ...
    GetEmptyPalletByWarehouse(value) {
      const params = {}
      if (value === '空托盘垛') {
        params.pallet_code = value
      }
      params.warehouse = 'D库'
      params.status = '启用'
