...
const api = {
  dataBy: '/BaseEquipment/GetBaseEquipmentBy',
  // dataUpdate: '/BaseEquipment/UpdateEquipByOrderId',
  // dataDel: '/Equip/DelSysUserByLoginName',
  dataAdd: '/BaseEquipment/AddBaseEquipment'
}
