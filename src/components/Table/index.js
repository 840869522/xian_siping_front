...
export default {
  ...
  created() {
    ...
    const localpageNo = this.pageURI && (pageNo && parseInt(pageNo)) || this.pageNo
    ...
    loadData(pagination, filters = this.filters, sorter = this.sorter) {
      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(r => {
          ...
          if (r.anything.length === 0 && this.showPagination && this.localPagination.current > 1) {
          ...
          this.localDataSource = r.anything // 返回结果中的数组数据
          if (this.showTotal) {
